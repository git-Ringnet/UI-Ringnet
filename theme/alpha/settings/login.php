...
$page = new admin_settingpage('theme_alpha_settingslogin', get_string('settingslogin', 'theme_alpha'));
	...
	$default = '<p class="small mb-0 text-center">Copyright © <strong>2022 alpha</strong>. All right reserved.
    <br>Alpha 2.0 Premium Moodle Theme by RoseaThemes.</p>';
	$setting = new alpha_setting_confightmleditor($name, $title, $description, $default);
	$page->add($setting);
	...
	$name = 'theme_alpha/colorloginbgtext';
	$title = get_string('colorloginbgtext', 'theme_alpha');
	$description = get_string('colorloginbgtext_desc', 'theme_alpha');

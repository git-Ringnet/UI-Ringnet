...
class theme_settings {
  ...
  public function global_settings() {
    ...
    $templatecontext = [];
    $elements = [
      'googlefonturl', 'seothemecolor', 'themeauthor', 'displaycustomalert', 'closecustomalert', 'topbarlogoareaonon'
    ];
    ...
    $elementshtml = [
      'stringmycourses', 'seometadesc', 'customalerthtml', 'customstcontent', 'customsmcontent', 'customsfcontent', 'customlogotxt', 'topbarcustomhtml'
    ];
	...
	if($lang == 'en'){
		 $templatecontext['customstcontent'] = format_text('Course information');
	}else {
		$templatecontext['customstcontent'] = format_text('Thông tin khoá học');
	}
  ...
  public function footer_settings() {
    ...
    $elements = [
      'customalert', 'darkmodetheme', 'footercustomcss', 'logincustomfooterhtml'
    ];

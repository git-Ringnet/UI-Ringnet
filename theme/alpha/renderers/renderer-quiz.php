...
class theme_alpha_core_question_renderer extends core_question_renderer {
    ...
    protected function number($number) {
        ...
        return html_writer::tag('h4', $numbertext, array('class' => 'rui-question-no mb-0 mr-3'));
    }
    ...
    protected function edit_question_link(question_attempt $qa,
        ...
        return html_writer::link($editurl, $icon, array('class' => 'btn btn-sm btn-success editquestion line-height-1'));
    }
